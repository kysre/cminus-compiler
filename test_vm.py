"""
You can run vm on your compiler output to run the intermediate generated code.
> python3 test_vm.py [path to your output file]
"""
import sys
import re
...
if __name__ == "__main__":
    ...
    run(program.readlines(), sys.stdout, sys.stderr)
